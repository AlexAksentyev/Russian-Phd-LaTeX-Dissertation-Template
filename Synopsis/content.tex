...
В \underline{\textbf{третьей главе}} описаны результаты экспериментов, проводимых на ускорителе COSY (находящемся на территории Исследовательского центра ``Юлих'', Германия).
