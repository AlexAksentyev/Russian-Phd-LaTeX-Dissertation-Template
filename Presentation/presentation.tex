...
\begin{frame}
	\begin{enumerate}[<+->]	\setcounter{enumi}{2}
		\item \textbf{Неидеальности ускорителя}
		\begin{itemize}
			\item Исследование зависимости наклона оси прецессии спина от распределения неидеальностей вдоль кольца
			\item Сравнение систематической ошибки измерений при движении пучка в кольце в прямом и обратном направлениях
		\end{itemize}
