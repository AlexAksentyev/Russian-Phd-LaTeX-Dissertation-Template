...
\begin{figure}[h]
	...
	\subbottom[Точки в выделенных областях более информативны]{%
		\begin{tikzpicture}
...
\begin{table}[h]
	\centering\captionsetup{width=.6\linewidth}
...
Данные параметры численной модели были выбраны исходя из следующих
...
\begin{figure}[H]
	...
	\includegraphics[width=\linewidth]{images/App_Stats/LR_detector_relErr}
	\end{minipage}~~~~%
...
\begin{figure}[H]
	\centering
	\begin{minipage}{.55\linewidth}
	\includegraphics[width=\linewidth]{images/App_Stats/Asymmetry}
	\end{minipage}~~~~%
	\begin{minipage}{.4\linewidth}
