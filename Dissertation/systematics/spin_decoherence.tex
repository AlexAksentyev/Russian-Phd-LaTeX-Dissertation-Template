...
\subsection{Симуляция секступольного подавления декогеренции в идеальном ускорителе}
\hl{ТЕКСТ}
\begin{figure}[!h]
	\centering
...
\begin{figure}[!h]\centering
	...
	\caption{Зависимость спин-тюна частицы от её смещения от референсной частицы.}
\end{figure}
...
\begin{figure}[h!]
	...
	\caption{Стандартное отклонение радиальной компоненты спин-вектора частицы от спин-вектора референсной частицы}
\end{figure}
...
\begin{figure}[h!]
	...
	\caption{Стандартное отклонение вертикальной компоненты спин-вектора частицы от спин-вектора референсной частицы}
\end{figure}
